...
We use the following third-party services to operate Your Key:
  ...
  OpenAI (AI Content Generation): The goals and descriptions you enter, along with your coaching conversation history, are sent to OpenAI's API to generate affirmations, visualisation scripts, and coaching responses. OpenAI processes this data subject to their data processing agreement. We do not send your name or email address to OpenAI — only the goal content you explicitly enter into the App.
...
Affirmations, guided visualisations, and coaching responses are generated by artificial intelligence (OpenAI GPT-4 and text-to-speech models). While we design our systems to produce high-quality, relevant, and uplifting content, AI-generated output may occasionally be imperfect, inconsistent, or not suited to your specific circumstances. This content is provided for personal development and motivational purposes only. Your Key does not guarantee specific outcomes or results from the use of AI-generated content.
